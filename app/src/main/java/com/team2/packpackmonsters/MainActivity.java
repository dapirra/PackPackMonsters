...
public class MainActivity extends AppCompatActivity implements DialogUserProfile.DialogUserProfileListener {
    ...
    private void displayDatabaseInfoMonster() {//TEST TO SEE IF DATABASE WORKS FOR MONSTER...
    ...
    private void displayDatabaseInfoMoves() {//TEST TO SEE IF DATABASE WORKS FOR MOVES...
